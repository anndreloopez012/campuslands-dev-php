# 08. Validacion defensiva - eventos campus
...
Ahora el ejercicio simula una pequena herramienta interna de eventos campus. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 8 se enfoca en validacion defensiva.
...
```bash
docker compose run --rm php php intermedio/ejercicio-008-validacion-defensiva-eventos-campus/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-008-validacion-defensiva-eventos-campus/resoluciones/tu-nombre/ejercicio.php
```
