# 28. Validacion defensiva - musica
...
Ahora el ejercicio simula una pequena herramienta interna de musica. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 28 se enfoca en validacion defensiva.
...
```bash
docker compose run --rm php php intermedio/ejercicio-028-validacion-defensiva-musica/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-028-validacion-defensiva-musica/resoluciones/tu-nombre/ejercicio.php
```
