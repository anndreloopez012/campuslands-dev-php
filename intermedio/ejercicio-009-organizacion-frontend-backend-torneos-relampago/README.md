# 09. Organizacion frontend backend - torneos relampago
...
Ahora el ejercicio simula una pequena herramienta interna de torneos relampago. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 9 se enfoca en organizacion frontend backend.
...
Practicar ordenar public, src y data usando PHP y aplicando estos conceptos: **estructura, rutas, assets**.
...
```bash
docker compose run --rm php php intermedio/ejercicio-009-organizacion-frontend-backend-torneos-relampago/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-009-organizacion-frontend-backend-torneos-relampago/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de torneos relampago.
...
echo "Ejercicio PHP - torneos relampago\n";
```
