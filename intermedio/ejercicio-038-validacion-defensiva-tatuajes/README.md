# 38. Validacion defensiva - tatuajes
...
Ahora el ejercicio simula una pequena herramienta interna de tatuajes. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 38 se enfoca en validacion defensiva.
...
```bash
docker compose run --rm php php intermedio/ejercicio-038-validacion-defensiva-tatuajes/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-038-validacion-defensiva-tatuajes/resoluciones/tu-nombre/ejercicio.php
```
