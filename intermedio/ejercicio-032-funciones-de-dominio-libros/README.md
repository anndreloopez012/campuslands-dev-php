# 32. Funciones de dominio - libros
...
Ahora el ejercicio simula una pequena herramienta interna de libros. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 32 se enfoca en funciones de dominio.
...
```bash
docker compose run --rm php php intermedio/ejercicio-032-funciones-de-dominio-libros/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-032-funciones-de-dominio-libros/resoluciones/tu-nombre/ejercicio.php
```
