...
Ahora el ejercicio simula una pequena herramienta interna de pingpong. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 27 se enfoca en plantillas php.
...
```bash
docker compose run --rm php php intermedio/ejercicio-027-plantillas-php-pingpong/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-027-plantillas-php-pingpong/resoluciones/tu-nombre/ejercicio.php
```
