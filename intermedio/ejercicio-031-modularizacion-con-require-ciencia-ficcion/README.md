# 31. Modularizacion con require - ciencia ficcion
...
Ahora el ejercicio simula una pequena herramienta interna de ciencia ficcion. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 31 se enfoca en modularizacion con require.
...
```bash
docker compose run --rm php php intermedio/ejercicio-031-modularizacion-con-require-ciencia-ficcion/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-031-modularizacion-con-require-ciencia-ficcion/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de ciencia ficcion.
...
echo "Ejercicio PHP - ciencia ficcion\n";
```
