# 40. Proyecto integrador medio - animacion 3D
...
Ahora el ejercicio simula una pequena herramienta interna de animacion 3D. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 40 se enfoca en proyecto integrador medio.
...
```bash
docker compose run --rm php php intermedio/ejercicio-040-proyecto-integrador-medio-animacion-3d/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-040-proyecto-integrador-medio-animacion-3d/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de animacion 3D.
...
echo "Ejercicio PHP - animacion 3D\n";
```
