# 06. Mini CRUD en memoria - gimnasio
...
Ahora el ejercicio simula una pequena herramienta interna de gimnasio. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 6 se enfoca en mini crud en memoria.
...
```bash
docker compose run --rm php php intermedio/ejercicio-006-mini-crud-en-memoria-gimnasio/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-006-mini-crud-en-memoria-gimnasio/resoluciones/tu-nombre/ejercicio.php
```
