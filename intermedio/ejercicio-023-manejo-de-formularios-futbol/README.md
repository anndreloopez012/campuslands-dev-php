# 23. Manejo de formularios - futbol
...
Ahora el ejercicio simula una pequena herramienta interna de futbol. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 23 se enfoca en manejo de formularios.
...
```bash
docker compose run --rm php php intermedio/ejercicio-023-manejo-de-formularios-futbol/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-023-manejo-de-formularios-futbol/resoluciones/tu-nombre/ejercicio.php
```
