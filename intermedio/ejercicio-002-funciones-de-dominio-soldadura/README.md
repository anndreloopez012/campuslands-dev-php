# 02. Funciones de dominio - soldadura
...
Ahora el ejercicio simula una pequena herramienta interna de soldadura. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 2 se enfoca en funciones de dominio.
...
```bash
docker compose run --rm php php intermedio/ejercicio-002-funciones-de-dominio-soldadura/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-002-funciones-de-dominio-soldadura/resoluciones/tu-nombre/ejercicio.php
```
