# 10. Proyecto integrador medio - inventarios mecanicos
...
inventarios mecanicos

## Contexto del problema

Ahora el ejercicio simula una pequena herramienta interna de inventarios mecanicos. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 10 se enfoca en proyecto integrador medio.
...
Practicar unir formularios, sesiones y persistencia simple usando PHP y aplicando estos conceptos: **flujo completo, archivos, validacion**.
...
```bash
docker compose run --rm php php intermedio/ejercicio-010-proyecto-integrador-medio-inventarios-mecanicos/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-010-proyecto-integrador-medio-inventarios-mecanicos/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de inventarios mecanicos.
...
echo "Ejercicio PHP - inventarios mecanicos\n";
```
