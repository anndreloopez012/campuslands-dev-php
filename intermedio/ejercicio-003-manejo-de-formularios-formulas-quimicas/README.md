# 03. Manejo de formularios - formulas quimicas
...
Ahora el ejercicio simula una pequena herramienta interna de formulas quimicas. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 3 se enfoca en manejo de formularios.
...
Practicar procesar datos enviados por usuario usando PHP y aplicando estos conceptos: **GET, POST, filter_input**.
...
```bash
docker compose run --rm php php intermedio/ejercicio-003-manejo-de-formularios-formulas-quimicas/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-003-manejo-de-formularios-formulas-quimicas/resoluciones/tu-nombre/ejercicio.php
```
