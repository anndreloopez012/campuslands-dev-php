# 29. Organizacion frontend backend - peliculas
...
Ahora el ejercicio simula una pequena herramienta interna de peliculas. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 29 se enfoca en organizacion frontend backend.
...
```bash
docker compose run --rm php php intermedio/ejercicio-029-organizacion-frontend-backend-peliculas/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-029-organizacion-frontend-backend-peliculas/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de peliculas.
