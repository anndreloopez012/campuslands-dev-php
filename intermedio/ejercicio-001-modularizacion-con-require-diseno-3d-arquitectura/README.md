# 01. Modularizacion con require - diseno 3D arquitectura
...
Ahora el ejercicio simula una pequena herramienta interna de diseno 3D arquitectura. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 1 se enfoca en modularizacion con require.
...
Practicar separar archivos por responsabilidad usando PHP y aplicando estos conceptos: **require, include, rutas**.
...
```bash
docker compose run --rm php php intermedio/ejercicio-001-modularizacion-con-require-diseno-3d-arquitectura/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-001-modularizacion-con-require-diseno-3d-arquitectura/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de diseno 3D arquitectura.
...
echo "Ejercicio PHP - diseno 3D arquitectura\n";
```
