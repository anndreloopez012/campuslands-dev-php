# 33. Manejo de formularios - comida
...
Ahora el ejercicio simula una pequena herramienta interna de comida. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 33 se enfoca en manejo de formularios.
...
```bash
docker compose run --rm php php intermedio/ejercicio-033-manejo-de-formularios-comida/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-033-manejo-de-formularios-comida/resoluciones/tu-nombre/ejercicio.php
```
