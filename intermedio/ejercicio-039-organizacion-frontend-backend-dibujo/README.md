# 39. Organizacion frontend backend - dibujo
...
Ahora el ejercicio simula una pequena herramienta interna de dibujo. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 39 se enfoca en organizacion frontend backend.
...
```bash
docker compose run --rm php php intermedio/ejercicio-039-organizacion-frontend-backend-dibujo/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-039-organizacion-frontend-backend-dibujo/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de dibujo.
