# 20. Proyecto integrador medio - autos de lujo
...
Ahora el ejercicio simula una pequena herramienta interna de autos de lujo. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 20 se enfoca en proyecto integrador medio.
...
```bash
docker compose run --rm php php intermedio/ejercicio-020-proyecto-integrador-medio-autos-de-lujo/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-020-proyecto-integrador-medio-autos-de-lujo/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de autos de lujo.
...
echo "Ejercicio PHP - autos de lujo\n";
```
