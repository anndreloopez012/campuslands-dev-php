# 37. Plantillas PHP - paracaidismo
...
Ahora el ejercicio simula una pequena herramienta interna de paracaidismo. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 37 se enfoca en plantillas php.
...
Practicar separar vista y logica basica usando PHP y aplicando estos conceptos: **partials, templates**.
...
```bash
docker compose run --rm php php intermedio/ejercicio-037-plantillas-php-paracaidismo/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-037-plantillas-php-paracaidismo/resoluciones/tu-nombre/ejercicio.php
```
