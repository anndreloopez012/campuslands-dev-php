# 16. Mini CRUD en memoria - accion y aventura
...
Ahora el ejercicio simula una pequena herramienta interna de accion y aventura. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 16 se enfoca en mini crud en memoria.
...
Practicar crear, listar, actualizar y eliminar registros usando PHP y aplicando estos conceptos: **arrays, ids, filtros**.
...
```bash
docker compose run --rm php php intermedio/ejercicio-016-mini-crud-en-memoria-accion-y-aventura/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-016-mini-crud-en-memoria-accion-y-aventura/resoluciones/tu-nombre/ejercicio.php
```
