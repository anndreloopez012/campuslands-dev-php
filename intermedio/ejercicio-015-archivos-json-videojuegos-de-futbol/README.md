# 15. Archivos JSON - videojuegos de futbol
...
Ahora el ejercicio simula una pequena herramienta interna de videojuegos de futbol. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 15 se enfoca en archivos json.
...
```bash
docker compose run --rm php php intermedio/ejercicio-015-archivos-json-videojuegos-de-futbol/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-015-archivos-json-videojuegos-de-futbol/resoluciones/tu-nombre/ejercicio.php
```
