# 21. Modularizacion con require - hiperdeportivos
...
Ahora el ejercicio simula una pequena herramienta interna de hiperdeportivos. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 21 se enfoca en modularizacion con require.
...
```bash
docker compose run --rm php php intermedio/ejercicio-021-modularizacion-con-require-hiperdeportivos/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-021-modularizacion-con-require-hiperdeportivos/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de hiperdeportivos.
...
echo "Ejercicio PHP - hiperdeportivos\n";
```
