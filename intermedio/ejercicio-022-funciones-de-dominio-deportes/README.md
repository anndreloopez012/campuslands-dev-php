# 22. Funciones de dominio - deportes
...
Ahora el ejercicio simula una pequena herramienta interna de deportes. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 22 se enfoca en funciones de dominio.
...
```bash
docker compose run --rm php php intermedio/ejercicio-022-funciones-de-dominio-deportes/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-022-funciones-de-dominio-deportes/resoluciones/tu-nombre/ejercicio.php
```
