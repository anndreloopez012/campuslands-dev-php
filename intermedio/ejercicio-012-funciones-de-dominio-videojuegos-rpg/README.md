# 12. Funciones de dominio - videojuegos RPG
...
Ahora el ejercicio simula una pequena herramienta interna de videojuegos RPG. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 12 se enfoca en funciones de dominio.
...
Practicar crear funciones para reglas concretas usando PHP y aplicando estos conceptos: **funciones puras, validacion**.
...
```bash
docker compose run --rm php php intermedio/ejercicio-012-funciones-de-dominio-videojuegos-rpg/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-012-funciones-de-dominio-videojuegos-rpg/resoluciones/tu-nombre/ejercicio.php
```
