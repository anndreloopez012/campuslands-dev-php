...
Ahora el ejercicio simula una pequena herramienta interna de e-sports. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 4 se enfoca en sesiones basicas.
...
```bash
docker compose run --rm php php intermedio/ejercicio-004-sesiones-basicas-e-sports/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-004-sesiones-basicas-e-sports/resoluciones/tu-nombre/ejercicio.php
```
