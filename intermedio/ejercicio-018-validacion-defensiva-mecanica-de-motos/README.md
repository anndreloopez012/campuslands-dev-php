# 18. Validacion defensiva - mecanica de motos
...
Ahora el ejercicio simula una pequena herramienta interna de mecanica de motos. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 18 se enfoca en validacion defensiva.
...
Practicar responder ante datos incompletos usando PHP y aplicando estos conceptos: **errores, mensajes, filtros**.
...
```bash
docker compose run --rm php php intermedio/ejercicio-018-validacion-defensiva-mecanica-de-motos/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-018-validacion-defensiva-mecanica-de-motos/resoluciones/tu-nombre/ejercicio.php
```
