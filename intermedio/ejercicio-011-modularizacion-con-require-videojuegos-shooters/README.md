# 11. Modularizacion con require - videojuegos shooters
...
Ahora el ejercicio simula una pequena herramienta interna de videojuegos shooters. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 11 se enfoca en modularizacion con require.
...
```bash
docker compose run --rm php php intermedio/ejercicio-011-modularizacion-con-require-videojuegos-shooters/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-011-modularizacion-con-require-videojuegos-shooters/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de videojuegos shooters.
...
echo "Ejercicio PHP - videojuegos shooters\n";
```
