# 26. Mini CRUD en memoria - carreras
...
Ahora el ejercicio simula una pequena herramienta interna de carreras. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 26 se enfoca en mini crud en memoria.
...
```bash
docker compose run --rm php php intermedio/ejercicio-026-mini-crud-en-memoria-carreras/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-026-mini-crud-en-memoria-carreras/resoluciones/tu-nombre/ejercicio.php
```
