# 36. Mini CRUD en memoria - turismo
...
Ahora el ejercicio simula una pequena herramienta interna de turismo. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 36 se enfoca en mini crud en memoria.
...
```bash
docker compose run --rm php php intermedio/ejercicio-036-mini-crud-en-memoria-turismo/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-036-mini-crud-en-memoria-turismo/resoluciones/tu-nombre/ejercicio.php
```
