# 24. Sesiones basicas - futbol sala
...
Ahora el ejercicio simula una pequena herramienta interna de futbol sala. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 24 se enfoca en sesiones basicas.
...
```bash
docker compose run --rm php php intermedio/ejercicio-024-sesiones-basicas-futbol-sala/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-024-sesiones-basicas-futbol-sala/resoluciones/tu-nombre/ejercicio.php
```
