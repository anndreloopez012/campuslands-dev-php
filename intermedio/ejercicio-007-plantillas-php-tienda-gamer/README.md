# 07. Plantillas PHP - tienda gamer
...
Ahora el ejercicio simula una pequena herramienta interna de tienda gamer. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 7 se enfoca en plantillas php.
...
```bash
docker compose run --rm php php intermedio/ejercicio-007-plantillas-php-tienda-gamer/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-007-plantillas-php-tienda-gamer/resoluciones/tu-nombre/ejercicio.php
```
