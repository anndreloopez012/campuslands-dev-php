# 13. Manejo de formularios - videojuegos MOBA
...
Ahora el ejercicio simula una pequena herramienta interna de videojuegos MOBA. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 13 se enfoca en manejo de formularios.
...
```bash
docker compose run --rm php php intermedio/ejercicio-013-manejo-de-formularios-videojuegos-moba/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-013-manejo-de-formularios-videojuegos-moba/resoluciones/tu-nombre/ejercicio.php
```
