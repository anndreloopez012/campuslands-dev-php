# 19. Organizacion frontend backend - autos
...
Ahora el ejercicio simula una pequena herramienta interna de autos. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 19 se enfoca en organizacion frontend backend.
...
```bash
docker compose run --rm php php intermedio/ejercicio-019-organizacion-frontend-backend-autos/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-019-organizacion-frontend-backend-autos/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de autos.
