# 14. Sesiones basicas - battle royale
...
Ahora el ejercicio simula una pequena herramienta interna de battle royale. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 14 se enfoca en sesiones basicas.
...
Practicar mantener estado local de usuario usando PHP y aplicando estos conceptos: **session_start, $_SESSION**.
...
```bash
docker compose run --rm php php intermedio/ejercicio-014-sesiones-basicas-battle-royale/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-014-sesiones-basicas-battle-royale/resoluciones/tu-nombre/ejercicio.php
```
