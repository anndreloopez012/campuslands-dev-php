...
Ahora el ejercicio simula una pequena herramienta interna de viajes. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 35 se enfoca en archivos json.
...
```bash
docker compose run --rm php php intermedio/ejercicio-035-archivos-json-viajes/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-035-archivos-json-viajes/resoluciones/tu-nombre/ejercicio.php
```
