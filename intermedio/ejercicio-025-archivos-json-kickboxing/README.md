...
Ahora el ejercicio simula una pequena herramienta interna de kickboxing. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 25 se enfoca en archivos json.
...
Practicar leer y escribir datos estructurados usando PHP y aplicando estos conceptos: **json_encode, json_decode, file_get_contents**.
...
```bash
docker compose run --rm php php intermedio/ejercicio-025-archivos-json-kickboxing/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-025-archivos-json-kickboxing/resoluciones/tu-nombre/ejercicio.php
```
