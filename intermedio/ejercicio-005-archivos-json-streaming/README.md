...
Ahora el ejercicio simula una pequena herramienta interna de streaming. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 5 se enfoca en archivos json.
...
```bash
docker compose run --rm php php intermedio/ejercicio-005-archivos-json-streaming/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-005-archivos-json-streaming/resoluciones/tu-nombre/ejercicio.php
```
