...
Ahora el ejercicio simula una pequena herramienta interna de motos. Debes separar mejor el codigo para que otra persona pueda leerlo, probarlo y extenderlo. El caso numero 17 se enfoca en plantillas php.
...
```bash
docker compose run --rm php php intermedio/ejercicio-017-plantillas-php-motos/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php intermedio/ejercicio-017-plantillas-php-motos/resoluciones/tu-nombre/ejercicio.php
```
