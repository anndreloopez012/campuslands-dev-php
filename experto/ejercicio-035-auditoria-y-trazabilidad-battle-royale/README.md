# 35. Auditoria y trazabilidad - battle royale
...
Actuas como responsable tecnico de un sistema PHP relacionado con battle royale. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 35 se enfoca en auditoria y trazabilidad.
...
Practicar registrar cambios importantes usando PHP y aplicando estos conceptos: **logs, auditoria, eventos**.
...
```bash
docker compose run --rm php php experto/ejercicio-035-auditoria-y-trazabilidad-battle-royale/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-035-auditoria-y-trazabilidad-battle-royale/resoluciones/tu-nombre/ejercicio.php
```
