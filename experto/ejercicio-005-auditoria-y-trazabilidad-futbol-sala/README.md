# 05. Auditoria y trazabilidad - futbol sala
...
Actuas como responsable tecnico de un sistema PHP relacionado con futbol sala. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 5 se enfoca en auditoria y trazabilidad.
...
```bash
docker compose run --rm php php experto/ejercicio-005-auditoria-y-trazabilidad-futbol-sala/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-005-auditoria-y-trazabilidad-futbol-sala/resoluciones/tu-nombre/ejercicio.php
```
