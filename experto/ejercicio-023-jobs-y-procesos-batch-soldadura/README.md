# 23. Jobs y procesos batch - soldadura
...
Actuas como responsable tecnico de un sistema PHP relacionado con soldadura. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 23 se enfoca en jobs y procesos batch.
...
```bash
docker compose run --rm php php experto/ejercicio-023-jobs-y-procesos-batch-soldadura/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-023-jobs-y-procesos-batch-soldadura/resoluciones/tu-nombre/ejercicio.php
```
