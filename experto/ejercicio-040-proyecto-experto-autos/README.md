...
Actuas como responsable tecnico de un sistema PHP relacionado con autos. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 40 se enfoca en proyecto experto.
...
```bash
docker compose run --rm php php experto/ejercicio-040-proyecto-experto-autos/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-040-proyecto-experto-autos/resoluciones/tu-nombre/ejercicio.php
```
