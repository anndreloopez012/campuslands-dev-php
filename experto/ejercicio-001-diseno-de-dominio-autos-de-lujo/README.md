# 01. Diseno de dominio - autos de lujo
...
Actuas como responsable tecnico de un sistema PHP relacionado con autos de lujo. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 1 se enfoca en diseno de dominio.
...
```bash
docker compose run --rm php php experto/ejercicio-001-diseno-de-dominio-autos-de-lujo/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-001-diseno-de-dominio-autos-de-lujo/resoluciones/tu-nombre/ejercicio.php
```
