# 32. Integraciones HTTP - videojuegos shooters
...
Actuas como responsable tecnico de un sistema PHP relacionado con videojuegos shooters. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 32 se enfoca en integraciones http.
...
```bash
docker compose run --rm php php experto/ejercicio-032-integraciones-http-videojuegos-shooters/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-032-integraciones-http-videojuegos-shooters/resoluciones/tu-nombre/ejercicio.php
```
