...
Actuas como responsable tecnico de un sistema PHP relacionado con dibujo. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 20 se enfoca en proyecto experto.
...
```bash
docker compose run --rm php php experto/ejercicio-020-proyecto-experto-dibujo/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-020-proyecto-experto-dibujo/resoluciones/tu-nombre/ejercicio.php
```
