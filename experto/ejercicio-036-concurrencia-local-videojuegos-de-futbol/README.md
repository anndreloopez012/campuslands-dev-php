# 36. Concurrencia local - videojuegos de futbol
...
Actuas como responsable tecnico de un sistema PHP relacionado con videojuegos de futbol. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 36 se enfoca en concurrencia local.
...
```bash
docker compose run --rm php php experto/ejercicio-036-concurrencia-local-videojuegos-de-futbol/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-036-concurrencia-local-videojuegos-de-futbol/resoluciones/tu-nombre/ejercicio.php
```
