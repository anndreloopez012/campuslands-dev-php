...
Actuas como responsable tecnico de un sistema PHP relacionado con pingpong. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 8 se enfoca en observabilidad.
...
```bash
docker compose run --rm php php experto/ejercicio-008-observabilidad-pingpong/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-008-observabilidad-pingpong/resoluciones/tu-nombre/ejercicio.php
```
