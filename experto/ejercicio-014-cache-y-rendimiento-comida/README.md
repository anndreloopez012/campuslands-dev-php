...
Actuas como responsable tecnico de un sistema PHP relacionado con comida. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 14 se enfoca en cache y rendimiento.
...
```bash
docker compose run --rm php php experto/ejercicio-014-cache-y-rendimiento-comida/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-014-cache-y-rendimiento-comida/resoluciones/tu-nombre/ejercicio.php
```
