# 03. Jobs y procesos batch - deportes
...
Actuas como responsable tecnico de un sistema PHP relacionado con deportes. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 3 se enfoca en jobs y procesos batch.
...
```bash
docker compose run --rm php php experto/ejercicio-003-jobs-y-procesos-batch-deportes/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-003-jobs-y-procesos-batch-deportes/resoluciones/tu-nombre/ejercicio.php
```
