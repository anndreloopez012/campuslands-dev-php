# 31. Diseno de dominio - inventarios mecanicos
...
Actuas como responsable tecnico de un sistema PHP relacionado con inventarios mecanicos. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 31 se enfoca en diseno de dominio.
...
Practicar modelar reglas complejas sin framework pesado usando PHP y aplicando estos conceptos: **entidades, servicios, value objects**.
...
```bash
docker compose run --rm php php experto/ejercicio-031-diseno-de-dominio-inventarios-mecanicos/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-031-diseno-de-dominio-inventarios-mecanicos/resoluciones/tu-nombre/ejercicio.php
```
