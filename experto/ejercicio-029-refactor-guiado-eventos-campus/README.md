# 29. Refactor guiado - eventos campus
...
Actuas como responsable tecnico de un sistema PHP relacionado con eventos campus. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 29 se enfoca en refactor guiado.
...
```bash
docker compose run --rm php php experto/ejercicio-029-refactor-guiado-eventos-campus/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-029-refactor-guiado-eventos-campus/resoluciones/tu-nombre/ejercicio.php
```
