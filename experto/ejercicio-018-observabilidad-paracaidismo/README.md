# 18. Observabilidad - paracaidismo
...
Actuas como responsable tecnico de un sistema PHP relacionado con paracaidismo. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 18 se enfoca en observabilidad.
...
Practicar medir errores, tiempos y operaciones usando PHP y aplicando estos conceptos: **logs estructurados, metricas simples**.
...
```bash
docker compose run --rm php php experto/ejercicio-018-observabilidad-paracaidismo/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-018-observabilidad-paracaidismo/resoluciones/tu-nombre/ejercicio.php
```
