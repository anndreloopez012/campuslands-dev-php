# 27. Configuracion por entorno - gimnasio
...
Actuas como responsable tecnico de un sistema PHP relacionado con gimnasio. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 27 se enfoca en configuracion por entorno.
...
```bash
docker compose run --rm php php experto/ejercicio-027-configuracion-por-entorno-gimnasio/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-027-configuracion-por-entorno-gimnasio/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de gimnasio.
