# 07. Configuracion por entorno - carreras
...
Actuas como responsable tecnico de un sistema PHP relacionado con carreras. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 7 se enfoca en configuracion por entorno.
...
```bash
docker compose run --rm php php experto/ejercicio-007-configuracion-por-entorno-carreras/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-007-configuracion-por-entorno-carreras/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de carreras.
