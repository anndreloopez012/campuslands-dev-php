# 39. Refactor guiado - mecanica de motos
...
Actuas como responsable tecnico de un sistema PHP relacionado con mecanica de motos. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 39 se enfoca en refactor guiado.
...
Practicar mejorar codigo sin romper comportamiento usando PHP y aplicando estos conceptos: **deuda tecnica, pruebas, contratos**.
...
```bash
docker compose run --rm php php experto/ejercicio-039-refactor-guiado-mecanica-de-motos/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-039-refactor-guiado-mecanica-de-motos/resoluciones/tu-nombre/ejercicio.php
```
