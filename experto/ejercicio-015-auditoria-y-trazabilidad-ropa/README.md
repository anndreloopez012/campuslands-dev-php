# 15. Auditoria y trazabilidad - ropa
...
Actuas como responsable tecnico de un sistema PHP relacionado con ropa. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 15 se enfoca en auditoria y trazabilidad.
...
```bash
docker compose run --rm php php experto/ejercicio-015-auditoria-y-trazabilidad-ropa/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-015-auditoria-y-trazabilidad-ropa/resoluciones/tu-nombre/ejercicio.php
```
