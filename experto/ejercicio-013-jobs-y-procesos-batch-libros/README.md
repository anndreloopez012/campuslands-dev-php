# 13. Jobs y procesos batch - libros
...
Actuas como responsable tecnico de un sistema PHP relacionado con libros. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 13 se enfoca en jobs y procesos batch.
...
```bash
docker compose run --rm php php experto/ejercicio-013-jobs-y-procesos-batch-libros/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-013-jobs-y-procesos-batch-libros/resoluciones/tu-nombre/ejercicio.php
```
