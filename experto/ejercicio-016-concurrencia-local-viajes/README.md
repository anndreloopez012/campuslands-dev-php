...
Actuas como responsable tecnico de un sistema PHP relacionado con viajes. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 16 se enfoca en concurrencia local.
...
```bash
docker compose run --rm php php experto/ejercicio-016-concurrencia-local-viajes/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-016-concurrencia-local-viajes/resoluciones/tu-nombre/ejercicio.php
```
