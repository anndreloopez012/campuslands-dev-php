# 12. Integraciones HTTP - ciencia ficcion
...
Actuas como responsable tecnico de un sistema PHP relacionado con ciencia ficcion. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 12 se enfoca en integraciones http.
...
```bash
docker compose run --rm php php experto/ejercicio-012-integraciones-http-ciencia-ficcion/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-012-integraciones-http-ciencia-ficcion/resoluciones/tu-nombre/ejercicio.php
```
