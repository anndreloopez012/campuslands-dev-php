# 26. Concurrencia local - streaming
...
Actuas como responsable tecnico de un sistema PHP relacionado con streaming. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 26 se enfoca en concurrencia local.
...
```bash
docker compose run --rm php php experto/ejercicio-026-concurrencia-local-streaming/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-026-concurrencia-local-streaming/resoluciones/tu-nombre/ejercicio.php
```
