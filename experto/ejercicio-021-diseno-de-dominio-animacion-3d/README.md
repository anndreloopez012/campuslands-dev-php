# 21. Diseno de dominio - animacion 3D
...
Actuas como responsable tecnico de un sistema PHP relacionado con animacion 3D. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 21 se enfoca en diseno de dominio.
...
```bash
docker compose run --rm php php experto/ejercicio-021-diseno-de-dominio-animacion-3d/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-021-diseno-de-dominio-animacion-3d/resoluciones/tu-nombre/ejercicio.php
```
