# 22. Integraciones HTTP - diseno 3D arquitectura
...
Actuas como responsable tecnico de un sistema PHP relacionado con diseno 3D arquitectura. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 22 se enfoca en integraciones http.
...
Practicar consumir y exponer servicios externos usando PHP y aplicando estos conceptos: **curl, HTTP client, retries**.
...
```bash
docker compose run --rm php php experto/ejercicio-022-integraciones-http-diseno-3d-arquitectura/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-022-integraciones-http-diseno-3d-arquitectura/resoluciones/tu-nombre/ejercicio.php
```
