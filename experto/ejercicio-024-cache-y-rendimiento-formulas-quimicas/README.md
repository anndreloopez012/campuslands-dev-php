# 24. Cache y rendimiento - formulas quimicas
...
Actuas como responsable tecnico de un sistema PHP relacionado con formulas quimicas. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 24 se enfoca en cache y rendimiento.
...
Practicar evitar trabajo repetido usando PHP y aplicando estos conceptos: **cache file, invalidacion**.
...
```bash
docker compose run --rm php php experto/ejercicio-024-cache-y-rendimiento-formulas-quimicas/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-024-cache-y-rendimiento-formulas-quimicas/resoluciones/tu-nombre/ejercicio.php
```
