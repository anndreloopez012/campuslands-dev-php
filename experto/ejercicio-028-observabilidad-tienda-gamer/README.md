# 28. Observabilidad - tienda gamer
...
Actuas como responsable tecnico de un sistema PHP relacionado con tienda gamer. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 28 se enfoca en observabilidad.
...
```bash
docker compose run --rm php php experto/ejercicio-028-observabilidad-tienda-gamer/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-028-observabilidad-tienda-gamer/resoluciones/tu-nombre/ejercicio.php
```
