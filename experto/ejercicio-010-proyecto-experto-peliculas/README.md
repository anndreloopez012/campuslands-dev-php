...
Actuas como responsable tecnico de un sistema PHP relacionado con peliculas. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 10 se enfoca en proyecto experto.
...
```bash
docker compose run --rm php php experto/ejercicio-010-proyecto-experto-peliculas/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-010-proyecto-experto-peliculas/resoluciones/tu-nombre/ejercicio.php
```
