# 33. Jobs y procesos batch - videojuegos RPG
...
Actuas como responsable tecnico de un sistema PHP relacionado con videojuegos RPG. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 33 se enfoca en jobs y procesos batch.
...
Practicar procesar tareas en segundo plano usando PHP y aplicando estos conceptos: **CLI, colas simuladas, logs**.
...
```bash
docker compose run --rm php php experto/ejercicio-033-jobs-y-procesos-batch-videojuegos-rpg/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-033-jobs-y-procesos-batch-videojuegos-rpg/resoluciones/tu-nombre/ejercicio.php
```
