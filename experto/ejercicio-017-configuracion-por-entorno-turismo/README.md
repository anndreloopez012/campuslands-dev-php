# 17. Configuracion por entorno - turismo
...
Actuas como responsable tecnico de un sistema PHP relacionado con turismo. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 17 se enfoca en configuracion por entorno.
...
```bash
docker compose run --rm php php experto/ejercicio-017-configuracion-por-entorno-turismo/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-017-configuracion-por-entorno-turismo/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de turismo.
