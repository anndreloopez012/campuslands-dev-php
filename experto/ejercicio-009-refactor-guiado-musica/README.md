...
Actuas como responsable tecnico de un sistema PHP relacionado con musica. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 9 se enfoca en refactor guiado.
...
```bash
docker compose run --rm php php experto/ejercicio-009-refactor-guiado-musica/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-009-refactor-guiado-musica/resoluciones/tu-nombre/ejercicio.php
```
