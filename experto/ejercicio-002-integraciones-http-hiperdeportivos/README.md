# 02. Integraciones HTTP - hiperdeportivos
...
Actuas como responsable tecnico de un sistema PHP relacionado con hiperdeportivos. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 2 se enfoca en integraciones http.
...
```bash
docker compose run --rm php php experto/ejercicio-002-integraciones-http-hiperdeportivos/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-002-integraciones-http-hiperdeportivos/resoluciones/tu-nombre/ejercicio.php
```
