...
Actuas como responsable tecnico de un sistema PHP relacionado con futbol. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 4 se enfoca en cache y rendimiento.
...
```bash
docker compose run --rm php php experto/ejercicio-004-cache-y-rendimiento-futbol/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-004-cache-y-rendimiento-futbol/resoluciones/tu-nombre/ejercicio.php
```
