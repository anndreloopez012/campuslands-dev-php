# 34. Cache y rendimiento - videojuegos MOBA
...
Actuas como responsable tecnico de un sistema PHP relacionado con videojuegos MOBA. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 34 se enfoca en cache y rendimiento.
...
```bash
docker compose run --rm php php experto/ejercicio-034-cache-y-rendimiento-videojuegos-moba/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-034-cache-y-rendimiento-videojuegos-moba/resoluciones/tu-nombre/ejercicio.php
```
