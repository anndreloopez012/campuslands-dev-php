# 25. Auditoria y trazabilidad - e-sports
...
Actuas como responsable tecnico de un sistema PHP relacionado con e-sports. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 25 se enfoca en auditoria y trazabilidad.
...
```bash
docker compose run --rm php php experto/ejercicio-025-auditoria-y-trazabilidad-e-sports/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-025-auditoria-y-trazabilidad-e-sports/resoluciones/tu-nombre/ejercicio.php
```
