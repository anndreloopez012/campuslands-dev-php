# 30. Proyecto experto - torneos relampago
...
Actuas como responsable tecnico de un sistema PHP relacionado con torneos relampago. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 30 se enfoca en proyecto experto.
...
Practicar integrar dominio, API, persistencia y operaciones usando PHP y aplicando estos conceptos: **arquitectura, seguridad, mantenimiento**.
...
```bash
docker compose run --rm php php experto/ejercicio-030-proyecto-experto-torneos-relampago/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-030-proyecto-experto-torneos-relampago/resoluciones/tu-nombre/ejercicio.php
```
