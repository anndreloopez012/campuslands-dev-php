...
Actuas como responsable tecnico de un sistema PHP relacionado con tatuajes. Debes pensar en escalabilidad local, errores, auditoria, integraciones y mantenimiento. El caso numero 19 se enfoca en refactor guiado.
...
```bash
docker compose run --rm php php experto/ejercicio-019-refactor-guiado-tatuajes/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php experto/ejercicio-019-refactor-guiado-tatuajes/resoluciones/tu-nombre/ejercicio.php
```
