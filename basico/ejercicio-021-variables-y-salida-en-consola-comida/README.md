# 21. Variables y salida en consola - comida
...
Estas creando un script PHP de consola para apoyar una dinamica de comida. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 21 se enfoca en variables y salida en consola.
...
```bash
docker compose run --rm php php basico/ejercicio-021-variables-y-salida-en-consola-comida/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-021-variables-y-salida-en-consola-comida/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de comida.
