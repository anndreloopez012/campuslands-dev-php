# 12. Tipos de datos y conversion - futbol sala
...
Estas creando un script PHP de consola para apoyar una dinamica de futbol sala. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 12 se enfoca en tipos de datos y conversion.
...
```bash
docker compose run --rm php php basico/ejercicio-012-tipos-de-datos-y-conversion-futbol-sala/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-012-tipos-de-datos-y-conversion-futbol-sala/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de futbol sala.
...
echo "Ejercicio PHP - futbol sala\n";
```
