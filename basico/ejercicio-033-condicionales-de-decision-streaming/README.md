# 33. Condicionales de decision - streaming
...
Estas creando un script PHP de consola para apoyar una dinamica de streaming. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 33 se enfoca en condicionales de decision.
...
```bash
docker compose run --rm php php basico/ejercicio-033-condicionales-de-decision-streaming/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-033-condicionales-de-decision-streaming/resoluciones/tu-nombre/ejercicio.php
```
