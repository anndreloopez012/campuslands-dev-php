# 31. Variables y salida en consola - formulas quimicas
...
Estas creando un script PHP de consola para apoyar una dinamica de formulas quimicas. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 31 se enfoca en variables y salida en consola.
...
Practicar crear variables claras, imprimir informacion y entender tipos basicos usando PHP y aplicando estos conceptos: **variables, echo, strings, numeros**.
...
```bash
docker compose run --rm php php basico/ejercicio-031-variables-y-salida-en-consola-formulas-quimicas/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-031-variables-y-salida-en-consola-formulas-quimicas/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de formulas quimicas.
...
echo "Ejercicio PHP - formulas quimicas\n";
```
