# 38. Validaciones simples - inventarios mecanicos
...
Estas creando un script PHP de consola para apoyar una dinamica de inventarios mecanicos. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 38 se enfoca en validaciones simples.
...
```bash
docker compose run --rm php php basico/ejercicio-038-validaciones-simples-inventarios-mecanicos/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-038-validaciones-simples-inventarios-mecanicos/resoluciones/tu-nombre/ejercicio.php
```
