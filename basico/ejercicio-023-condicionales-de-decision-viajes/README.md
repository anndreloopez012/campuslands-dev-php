# 23. Condicionales de decision - viajes
...
Estas creando un script PHP de consola para apoyar una dinamica de viajes. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 23 se enfoca en condicionales de decision.
...
```bash
docker compose run --rm php php basico/ejercicio-023-condicionales-de-decision-viajes/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-023-condicionales-de-decision-viajes/resoluciones/tu-nombre/ejercicio.php
```
