# 04. Ciclos controlados - accion y aventura
...
Estas creando un script PHP de consola para apoyar una dinamica de accion y aventura. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 4 se enfoca en ciclos controlados.
...
Practicar recorrer datos con contador y condiciones usando PHP y aplicando estos conceptos: **for, while, foreach**.
...
```bash
docker compose run --rm php php basico/ejercicio-004-ciclos-controlados-accion-y-aventura/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-004-ciclos-controlados-accion-y-aventura/resoluciones/tu-nombre/ejercicio.php
```
