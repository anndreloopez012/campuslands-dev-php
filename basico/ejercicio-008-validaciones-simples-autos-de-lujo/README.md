# 08. Validaciones simples - autos de lujo
...
Estas creando un script PHP de consola para apoyar una dinamica de autos de lujo. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 8 se enfoca en validaciones simples.
...
```bash
docker compose run --rm php php basico/ejercicio-008-validaciones-simples-autos-de-lujo/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-008-validaciones-simples-autos-de-lujo/resoluciones/tu-nombre/ejercicio.php
```
