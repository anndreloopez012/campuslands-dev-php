# 19. Ranking y puntajes - ciencia ficcion
...
Estas creando un script PHP de consola para apoyar una dinamica de ciencia ficcion. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 19 se enfoca en ranking y puntajes.
...
```bash
docker compose run --rm php php basico/ejercicio-019-ranking-y-puntajes-ciencia-ficcion/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-019-ranking-y-puntajes-ciencia-ficcion/resoluciones/tu-nombre/ejercicio.php
```
