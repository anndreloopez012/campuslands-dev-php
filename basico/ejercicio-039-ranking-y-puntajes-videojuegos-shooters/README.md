# 39. Ranking y puntajes - videojuegos shooters
...
Estas creando un script PHP de consola para apoyar una dinamica de videojuegos shooters. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 39 se enfoca en ranking y puntajes.
...
```bash
docker compose run --rm php php basico/ejercicio-039-ranking-y-puntajes-videojuegos-shooters/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-039-ranking-y-puntajes-videojuegos-shooters/resoluciones/tu-nombre/ejercicio.php
```
