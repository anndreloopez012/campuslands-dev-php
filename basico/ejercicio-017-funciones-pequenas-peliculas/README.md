# 17. Funciones pequenas - peliculas
...
Estas creando un script PHP de consola para apoyar una dinamica de peliculas. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 17 se enfoca en funciones pequenas.
...
```bash
docker compose run --rm php php basico/ejercicio-017-funciones-pequenas-peliculas/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-017-funciones-pequenas-peliculas/resoluciones/tu-nombre/ejercicio.php
```
