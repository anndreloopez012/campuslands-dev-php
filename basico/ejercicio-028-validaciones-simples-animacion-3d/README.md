# 28. Validaciones simples - animacion 3D
...
Estas creando un script PHP de consola para apoyar una dinamica de animacion 3D. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 28 se enfoca en validaciones simples.
...
```bash
docker compose run --rm php php basico/ejercicio-028-validaciones-simples-animacion-3d/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-028-validaciones-simples-animacion-3d/resoluciones/tu-nombre/ejercicio.php
```
