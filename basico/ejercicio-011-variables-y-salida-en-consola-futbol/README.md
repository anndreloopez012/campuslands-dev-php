# 11. Variables y salida en consola - futbol
...
Estas creando un script PHP de consola para apoyar una dinamica de futbol. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 11 se enfoca en variables y salida en consola.
...
```bash
docker compose run --rm php php basico/ejercicio-011-variables-y-salida-en-consola-futbol/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-011-variables-y-salida-en-consola-futbol/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de futbol.
