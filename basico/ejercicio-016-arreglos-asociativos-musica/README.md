# 16. Arreglos asociativos - musica
...
Estas creando un script PHP de consola para apoyar una dinamica de musica. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 16 se enfoca en arreglos asociativos.
...
```bash
docker compose run --rm php php basico/ejercicio-016-arreglos-asociativos-musica/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-016-arreglos-asociativos-musica/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de musica.
