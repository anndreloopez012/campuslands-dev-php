# 22. Tipos de datos y conversion - ropa
...
Estas creando un script PHP de consola para apoyar una dinamica de ropa. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 22 se enfoca en tipos de datos y conversion.
...
```bash
docker compose run --rm php php basico/ejercicio-022-tipos-de-datos-y-conversion-ropa/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-022-tipos-de-datos-y-conversion-ropa/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de ropa.
