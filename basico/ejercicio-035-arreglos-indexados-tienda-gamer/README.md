# 35. Arreglos indexados - tienda gamer
...
Estas creando un script PHP de consola para apoyar una dinamica de tienda gamer. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 35 se enfoca en arreglos indexados.
...
Practicar guardar listas de elementos y recorrerlas usando PHP y aplicando estos conceptos: **arrays, count, foreach**.
...
```bash
docker compose run --rm php php basico/ejercicio-035-arreglos-indexados-tienda-gamer/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-035-arreglos-indexados-tienda-gamer/resoluciones/tu-nombre/ejercicio.php
```
