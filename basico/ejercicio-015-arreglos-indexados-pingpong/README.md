# 15. Arreglos indexados - pingpong
...
Estas creando un script PHP de consola para apoyar una dinamica de pingpong. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 15 se enfoca en arreglos indexados.
...
```bash
docker compose run --rm php php basico/ejercicio-015-arreglos-indexados-pingpong/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-015-arreglos-indexados-pingpong/resoluciones/tu-nombre/ejercicio.php
```
