# 06. Arreglos asociativos - mecanica de motos
...
Estas creando un script PHP de consola para apoyar una dinamica de mecanica de motos. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 6 se enfoca en arreglos asociativos.
...
Practicar modelar entidades con claves descriptivas usando PHP y aplicando estos conceptos: **arrays asociativos, claves**.
...
```bash
docker compose run --rm php php basico/ejercicio-006-arreglos-asociativos-mecanica-de-motos/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-006-arreglos-asociativos-mecanica-de-motos/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de mecanica de motos.
...
echo "Ejercicio PHP - mecanica de motos\n";
```
