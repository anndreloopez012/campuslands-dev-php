# 40. Estadisticas basicas - videojuegos RPG
...
Estas creando un script PHP de consola para apoyar una dinamica de videojuegos RPG. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 40 se enfoca en estadisticas basicas.
...
Practicar sumar, promediar, contar y comparar usando PHP y aplicando estos conceptos: **min, max, promedio, porcentajes**.
...
```bash
docker compose run --rm php php basico/ejercicio-040-estadisticas-basicas-videojuegos-rpg/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-040-estadisticas-basicas-videojuegos-rpg/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de videojuegos RPG.
...
echo "Ejercicio PHP - videojuegos RPG\n";
```
