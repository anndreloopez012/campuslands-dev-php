# 20. Estadisticas basicas - libros
...
Estas creando un script PHP de consola para apoyar una dinamica de libros. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 20 se enfoca en estadisticas basicas.
...
```bash
docker compose run --rm php php basico/ejercicio-020-estadisticas-basicas-libros/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-020-estadisticas-basicas-libros/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de libros.
