# 26. Arreglos asociativos - tatuajes
...
Estas creando un script PHP de consola para apoyar una dinamica de tatuajes. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 26 se enfoca en arreglos asociativos.
...
```bash
docker compose run --rm php php basico/ejercicio-026-arreglos-asociativos-tatuajes/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-026-arreglos-asociativos-tatuajes/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de tatuajes.
