...
Estas creando un script PHP de consola para apoyar una dinamica de motos. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 5 se enfoca en arreglos indexados.
...
```bash
docker compose run --rm php php basico/ejercicio-005-arreglos-indexados-motos/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-005-arreglos-indexados-motos/resoluciones/tu-nombre/ejercicio.php
```
