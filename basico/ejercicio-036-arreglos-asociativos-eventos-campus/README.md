# 36. Arreglos asociativos - eventos campus
...
Estas creando un script PHP de consola para apoyar una dinamica de eventos campus. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 36 se enfoca en arreglos asociativos.
...
```bash
docker compose run --rm php php basico/ejercicio-036-arreglos-asociativos-eventos-campus/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-036-arreglos-asociativos-eventos-campus/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de eventos campus.
...
echo "Ejercicio PHP - eventos campus\n";
```
