# 09. Ranking y puntajes - hiperdeportivos
...
Estas creando un script PHP de consola para apoyar una dinamica de hiperdeportivos. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 9 se enfoca en ranking y puntajes.
...
```bash
docker compose run --rm php php basico/ejercicio-009-ranking-y-puntajes-hiperdeportivos/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-009-ranking-y-puntajes-hiperdeportivos/resoluciones/tu-nombre/ejercicio.php
```
