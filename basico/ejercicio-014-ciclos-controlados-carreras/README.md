# 14. Ciclos controlados - carreras
...
Estas creando un script PHP de consola para apoyar una dinamica de carreras. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 14 se enfoca en ciclos controlados.
...
```bash
docker compose run --rm php php basico/ejercicio-014-ciclos-controlados-carreras/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-014-ciclos-controlados-carreras/resoluciones/tu-nombre/ejercicio.php
```
