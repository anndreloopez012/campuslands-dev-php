# 01. Variables y salida en consola - videojuegos MOBA
...
Estas creando un script PHP de consola para apoyar una dinamica de videojuegos MOBA. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 1 se enfoca en variables y salida en consola.
...
```bash
docker compose run --rm php php basico/ejercicio-001-variables-y-salida-en-consola-videojuegos-moba/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-001-variables-y-salida-en-consola-videojuegos-moba/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de videojuegos MOBA.
...
echo "Ejercicio PHP - videojuegos MOBA\n";
```
