# 30. Estadisticas basicas - soldadura
...
Estas creando un script PHP de consola para apoyar una dinamica de soldadura. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 30 se enfoca en estadisticas basicas.
...
```bash
docker compose run --rm php php basico/ejercicio-030-estadisticas-basicas-soldadura/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-030-estadisticas-basicas-soldadura/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de soldadura.
