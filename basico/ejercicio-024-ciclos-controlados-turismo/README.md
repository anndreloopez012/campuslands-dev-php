...
Estas creando un script PHP de consola para apoyar una dinamica de turismo. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 24 se enfoca en ciclos controlados.
...
```bash
docker compose run --rm php php basico/ejercicio-024-ciclos-controlados-turismo/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-024-ciclos-controlados-turismo/resoluciones/tu-nombre/ejercicio.php
```
