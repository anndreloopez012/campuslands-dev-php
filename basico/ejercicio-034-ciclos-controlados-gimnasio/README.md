# 34. Ciclos controlados - gimnasio
...
Estas creando un script PHP de consola para apoyar una dinamica de gimnasio. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 34 se enfoca en ciclos controlados.
...
```bash
docker compose run --rm php php basico/ejercicio-034-ciclos-controlados-gimnasio/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-034-ciclos-controlados-gimnasio/resoluciones/tu-nombre/ejercicio.php
```
