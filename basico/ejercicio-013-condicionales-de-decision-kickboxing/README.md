# 13. Condicionales de decision - kickboxing
...
Estas creando un script PHP de consola para apoyar una dinamica de kickboxing. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 13 se enfoca en condicionales de decision.
...
```bash
docker compose run --rm php php basico/ejercicio-013-condicionales-de-decision-kickboxing/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-013-condicionales-de-decision-kickboxing/resoluciones/tu-nombre/ejercicio.php
```
