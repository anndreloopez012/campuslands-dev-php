# 29. Ranking y puntajes - diseno 3D arquitectura
...
Estas creando un script PHP de consola para apoyar una dinamica de diseno 3D arquitectura. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 29 se enfoca en ranking y puntajes.
...
Practicar ordenar resultados y calcular posiciones usando PHP y aplicando estos conceptos: **sort, usort, acumuladores**.
...
```bash
docker compose run --rm php php basico/ejercicio-029-ranking-y-puntajes-diseno-3d-arquitectura/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-029-ranking-y-puntajes-diseno-3d-arquitectura/resoluciones/tu-nombre/ejercicio.php
```
