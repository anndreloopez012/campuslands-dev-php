...
Estas creando un script PHP de consola para apoyar una dinamica de dibujo. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 27 se enfoca en funciones pequenas.
...
```bash
docker compose run --rm php php basico/ejercicio-027-funciones-pequenas-dibujo/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-027-funciones-pequenas-dibujo/resoluciones/tu-nombre/ejercicio.php
```
