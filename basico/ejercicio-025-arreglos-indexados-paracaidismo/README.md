# 25. Arreglos indexados - paracaidismo
...
Estas creando un script PHP de consola para apoyar una dinamica de paracaidismo. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 25 se enfoca en arreglos indexados.
...
```bash
docker compose run --rm php php basico/ejercicio-025-arreglos-indexados-paracaidismo/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-025-arreglos-indexados-paracaidismo/resoluciones/tu-nombre/ejercicio.php
```
