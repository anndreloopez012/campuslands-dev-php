# 37. Funciones pequenas - torneos relampago
...
Estas creando un script PHP de consola para apoyar una dinamica de torneos relampago. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 37 se enfoca en funciones pequenas.
...
Practicar separar reglas en funciones reutilizables usando PHP y aplicando estos conceptos: **function, parametros, return**.
...
```bash
docker compose run --rm php php basico/ejercicio-037-funciones-pequenas-torneos-relampago/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-037-funciones-pequenas-torneos-relampago/resoluciones/tu-nombre/ejercicio.php
```
