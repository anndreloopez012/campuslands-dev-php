# 02. Tipos de datos y conversion - battle royale
...
Estas creando un script PHP de consola para apoyar una dinamica de battle royale. El reto no es hacer una app completa: debes concentrarte en entender datos, condiciones y resultados claros. El caso numero 2 se enfoca en tipos de datos y conversion.
...
Practicar validar strings, enteros, floats, booleanos y null usando PHP y aplicando estos conceptos: **tipos, casting, var_dump**.
...
```bash
docker compose run --rm php php basico/ejercicio-002-tipos-de-datos-y-conversion-battle-royale/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php basico/ejercicio-002-tipos-de-datos-y-conversion-battle-royale/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de battle royale.
...
echo "Ejercicio PHP - battle royale\n";
```
