...
```bash
docker pull ghcr.io/anndreloopez012/campuslands-dev-php:dev
docker run --rm -p 8080:80 ghcr.io/anndreloopez012/campuslands-dev-php:dev
```
...
- `dev` publica la etiqueta `ghcr.io/anndreloopez012/campuslands-dev-php:dev`.
- `main` publica la etiqueta `ghcr.io/anndreloopez012/campuslands-dev-php:latest`.
