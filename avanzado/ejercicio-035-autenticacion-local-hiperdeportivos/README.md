# 35. Autenticacion local - hiperdeportivos
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con hiperdeportivos. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 35 se enfoca en autenticacion local.
...
```bash
docker compose run --rm php php avanzado/ejercicio-035-autenticacion-local-hiperdeportivos/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-035-autenticacion-local-hiperdeportivos/resoluciones/tu-nombre/ejercicio.php
```
