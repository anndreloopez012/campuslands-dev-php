# 39. Arquitectura por capas - kickboxing
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con kickboxing. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 39 se enfoca en arquitectura por capas.
...
Practicar separar public, src, config y storage usando PHP y aplicando estos conceptos: **capas, responsabilidades**.
...
```bash
docker compose run --rm php php avanzado/ejercicio-039-arquitectura-por-capas-kickboxing/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-039-arquitectura-por-capas-kickboxing/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de kickboxing.
