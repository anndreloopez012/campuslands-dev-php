# 11. PDO y consultas preparadas - paracaidismo
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con paracaidismo. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 11 se enfoca en pdo y consultas preparadas.
...
Practicar conectar PHP con base de datos de forma segura usando PHP y aplicando estos conceptos: **PDO, prepared statements**.
...
```bash
docker compose run --rm php php avanzado/ejercicio-011-pdo-y-consultas-preparadas-paracaidismo/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-011-pdo-y-consultas-preparadas-paracaidismo/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de paracaidismo.
...
echo "Ejercicio PHP - paracaidismo\n";
```
