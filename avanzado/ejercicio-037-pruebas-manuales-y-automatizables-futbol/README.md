# 37. Pruebas manuales y automatizables - futbol
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con futbol. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 37 se enfoca en pruebas manuales y automatizables.
...
```bash
docker compose run --rm php php avanzado/ejercicio-037-pruebas-manuales-y-automatizables-futbol/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-037-pruebas-manuales-y-automatizables-futbol/resoluciones/tu-nombre/ejercicio.php
```
