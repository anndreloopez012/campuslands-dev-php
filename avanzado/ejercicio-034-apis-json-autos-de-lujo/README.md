...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con autos de lujo. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 34 se enfoca en apis json.
...
```bash
docker compose run --rm php php avanzado/ejercicio-034-apis-json-autos-de-lujo/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-034-apis-json-autos-de-lujo/resoluciones/tu-nombre/ejercicio.php
```
