# 22. Repositorios simples - eventos campus
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con eventos campus. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 22 se enfoca en repositorios simples.
...
```bash
docker compose run --rm php php avanzado/ejercicio-022-repositorios-simples-eventos-campus/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-022-repositorios-simples-eventos-campus/resoluciones/tu-nombre/ejercicio.php
```
