# 01. PDO y consultas preparadas - pingpong
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con pingpong. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 1 se enfoca en pdo y consultas preparadas.
...
```bash
docker compose run --rm php php avanzado/ejercicio-001-pdo-y-consultas-preparadas-pingpong/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-001-pdo-y-consultas-preparadas-pingpong/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de pingpong.
