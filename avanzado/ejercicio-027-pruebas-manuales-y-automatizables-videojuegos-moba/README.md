# 27. Pruebas manuales y automatizables - videojuegos MOBA
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con videojuegos MOBA. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 27 se enfoca en pruebas manuales y automatizables.
...
```bash
docker compose run --rm php php avanzado/ejercicio-027-pruebas-manuales-y-automatizables-videojuegos-moba/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-027-pruebas-manuales-y-automatizables-videojuegos-moba/resoluciones/tu-nombre/ejercicio.php
```
