# 05. Autenticacion local - ciencia ficcion
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con ciencia ficcion. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 5 se enfoca en autenticacion local.
...
```bash
docker compose run --rm php php avanzado/ejercicio-005-autenticacion-local-ciencia-ficcion/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-005-autenticacion-local-ciencia-ficcion/resoluciones/tu-nombre/ejercicio.php
```
