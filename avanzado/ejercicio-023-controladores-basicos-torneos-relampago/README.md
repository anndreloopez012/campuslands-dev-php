# 23. Controladores basicos - torneos relampago
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con torneos relampago. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 23 se enfoca en controladores basicos.
...
Practicar recibir peticiones y coordinar respuestas usando PHP y aplicando estos conceptos: **controllers, request, response**.
...
```bash
docker compose run --rm php php avanzado/ejercicio-023-controladores-basicos-torneos-relampago/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-023-controladores-basicos-torneos-relampago/resoluciones/tu-nombre/ejercicio.php
```
