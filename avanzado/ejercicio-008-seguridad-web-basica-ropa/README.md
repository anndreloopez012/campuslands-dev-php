...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con ropa. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 8 se enfoca en seguridad web basica.
...
```bash
docker compose run --rm php php avanzado/ejercicio-008-seguridad-web-basica-ropa/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-008-seguridad-web-basica-ropa/resoluciones/tu-nombre/ejercicio.php
```
