# 24. APIs JSON - inventarios mecanicos
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con inventarios mecanicos. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 24 se enfoca en apis json.
...
Practicar crear endpoints claros para consumo externo usando PHP y aplicando estos conceptos: **headers, json, status codes**.
...
```bash
docker compose run --rm php php avanzado/ejercicio-024-apis-json-inventarios-mecanicos/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-024-apis-json-inventarios-mecanicos/resoluciones/tu-nombre/ejercicio.php
```
