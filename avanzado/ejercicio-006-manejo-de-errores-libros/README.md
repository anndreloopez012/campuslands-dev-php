...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con libros. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 6 se enfoca en manejo de errores.
...
```bash
docker compose run --rm php php avanzado/ejercicio-006-manejo-de-errores-libros/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-006-manejo-de-errores-libros/resoluciones/tu-nombre/ejercicio.php
```
