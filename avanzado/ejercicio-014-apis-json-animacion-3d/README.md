...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con animacion 3D. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 14 se enfoca en apis json.
...
```bash
docker compose run --rm php php avanzado/ejercicio-014-apis-json-animacion-3d/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-014-apis-json-animacion-3d/resoluciones/tu-nombre/ejercicio.php
```
