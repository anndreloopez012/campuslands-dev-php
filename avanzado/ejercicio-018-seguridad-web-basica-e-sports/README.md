# 18. Seguridad web basica - e-sports
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con e-sports. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 18 se enfoca en seguridad web basica.
...
```bash
docker compose run --rm php php avanzado/ejercicio-018-seguridad-web-basica-e-sports/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-018-seguridad-web-basica-e-sports/resoluciones/tu-nombre/ejercicio.php
```
