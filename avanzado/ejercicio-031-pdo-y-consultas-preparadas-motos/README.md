# 31. PDO y consultas preparadas - motos
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con motos. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 31 se enfoca en pdo y consultas preparadas.
...
```bash
docker compose run --rm php php avanzado/ejercicio-031-pdo-y-consultas-preparadas-motos/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-031-pdo-y-consultas-preparadas-motos/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de motos.
