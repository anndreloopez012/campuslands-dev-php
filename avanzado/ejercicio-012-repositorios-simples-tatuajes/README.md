# 12. Repositorios simples - tatuajes
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con tatuajes. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 12 se enfoca en repositorios simples.
...
```bash
docker compose run --rm php php avanzado/ejercicio-012-repositorios-simples-tatuajes/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-012-repositorios-simples-tatuajes/resoluciones/tu-nombre/ejercicio.php
```
