...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con gimnasio. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 20 se enfoca en proyecto avanzado.
...
```bash
docker compose run --rm php php avanzado/ejercicio-020-proyecto-avanzado-gimnasio/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-020-proyecto-avanzado-gimnasio/resoluciones/tu-nombre/ejercicio.php
```
