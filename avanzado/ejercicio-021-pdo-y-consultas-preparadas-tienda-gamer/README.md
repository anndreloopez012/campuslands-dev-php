# 21. PDO y consultas preparadas - tienda gamer
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con tienda gamer. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 21 se enfoca en pdo y consultas preparadas.
...
```bash
docker compose run --rm php php avanzado/ejercicio-021-pdo-y-consultas-preparadas-tienda-gamer/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-021-pdo-y-consultas-preparadas-tienda-gamer/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de tienda gamer.
...
echo "Ejercicio PHP - tienda gamer\n";
```
