# 32. Repositorios simples - mecanica de motos
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con mecanica de motos. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 32 se enfoca en repositorios simples.
...
Practicar aislar acceso a datos usando PHP y aplicando estos conceptos: **Repository, entidades, mapping**.
...
```bash
docker compose run --rm php php avanzado/ejercicio-032-repositorios-simples-mecanica-de-motos/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-032-repositorios-simples-mecanica-de-motos/resoluciones/tu-nombre/ejercicio.php
```
