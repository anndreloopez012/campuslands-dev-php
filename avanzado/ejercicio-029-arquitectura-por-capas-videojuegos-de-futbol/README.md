# 29. Arquitectura por capas - videojuegos de futbol
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con videojuegos de futbol. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 29 se enfoca en arquitectura por capas.
...
```bash
docker compose run --rm php php avanzado/ejercicio-029-arquitectura-por-capas-videojuegos-de-futbol/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-029-arquitectura-por-capas-videojuegos-de-futbol/resoluciones/tu-nombre/ejercicio.php
```
