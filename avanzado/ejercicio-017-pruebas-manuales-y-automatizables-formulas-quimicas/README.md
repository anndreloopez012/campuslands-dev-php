# 17. Pruebas manuales y automatizables - formulas quimicas
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con formulas quimicas. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 17 se enfoca en pruebas manuales y automatizables.
...
Practicar comprobar funciones criticas usando PHP y aplicando estos conceptos: **assert, casos borde**.
...
```bash
docker compose run --rm php php avanzado/ejercicio-017-pruebas-manuales-y-automatizables-formulas-quimicas/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-017-pruebas-manuales-y-automatizables-formulas-quimicas/resoluciones/tu-nombre/ejercicio.php
```
