# 16. Manejo de errores - soldadura
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con soldadura. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 16 se enfoca en manejo de errores.
...
```bash
docker compose run --rm php php avanzado/ejercicio-016-manejo-de-errores-soldadura/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-016-manejo-de-errores-soldadura/resoluciones/tu-nombre/ejercicio.php
```
