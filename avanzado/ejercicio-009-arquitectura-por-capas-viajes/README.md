# 09. Arquitectura por capas - viajes
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con viajes. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 9 se enfoca en arquitectura por capas.
...
```bash
docker compose run --rm php php avanzado/ejercicio-009-arquitectura-por-capas-viajes/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-009-arquitectura-por-capas-viajes/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de viajes.
