...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con turismo. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 10 se enfoca en proyecto avanzado.
...
```bash
docker compose run --rm php php avanzado/ejercicio-010-proyecto-avanzado-turismo/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-010-proyecto-avanzado-turismo/resoluciones/tu-nombre/ejercicio.php
```
