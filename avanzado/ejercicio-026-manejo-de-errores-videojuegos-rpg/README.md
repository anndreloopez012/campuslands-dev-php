# 26. Manejo de errores - videojuegos RPG
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con videojuegos RPG. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 26 se enfoca en manejo de errores.
...
Practicar centralizar errores y logs usando PHP y aplicando estos conceptos: **try/catch, exceptions, logs**.
...
```bash
docker compose run --rm php php avanzado/ejercicio-026-manejo-de-errores-videojuegos-rpg/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-026-manejo-de-errores-videojuegos-rpg/resoluciones/tu-nombre/ejercicio.php
```
