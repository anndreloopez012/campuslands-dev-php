# 19. Arquitectura por capas - streaming
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con streaming. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 19 se enfoca en arquitectura por capas.
...
```bash
docker compose run --rm php php avanzado/ejercicio-019-arquitectura-por-capas-streaming/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-019-arquitectura-por-capas-streaming/resoluciones/tu-nombre/ejercicio.php
```
...
- La salida responde al contexto de streaming.
