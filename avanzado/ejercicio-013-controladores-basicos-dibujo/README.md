# 13. Controladores basicos - dibujo
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con dibujo. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 13 se enfoca en controladores basicos.
...
```bash
docker compose run --rm php php avanzado/ejercicio-013-controladores-basicos-dibujo/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-013-controladores-basicos-dibujo/resoluciones/tu-nombre/ejercicio.php
```
