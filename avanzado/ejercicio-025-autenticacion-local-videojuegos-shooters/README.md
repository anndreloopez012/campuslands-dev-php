# 25. Autenticacion local - videojuegos shooters
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con videojuegos shooters. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 25 se enfoca en autenticacion local.
...
```bash
docker compose run --rm php php avanzado/ejercicio-025-autenticacion-local-videojuegos-shooters/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-025-autenticacion-local-videojuegos-shooters/resoluciones/tu-nombre/ejercicio.php
```
