# 02. Repositorios simples - musica
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con musica. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 2 se enfoca en repositorios simples.
...
```bash
docker compose run --rm php php avanzado/ejercicio-002-repositorios-simples-musica/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-002-repositorios-simples-musica/resoluciones/tu-nombre/ejercicio.php
```
