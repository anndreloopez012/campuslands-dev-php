...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con carreras. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 40 se enfoca en proyecto avanzado.
...
```bash
docker compose run --rm php php avanzado/ejercicio-040-proyecto-avanzado-carreras/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-040-proyecto-avanzado-carreras/resoluciones/tu-nombre/ejercicio.php
```
