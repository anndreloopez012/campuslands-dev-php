# 28. Seguridad web basica - battle royale
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con battle royale. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 28 se enfoca en seguridad web basica.
...
Practicar reducir XSS, SQL injection y datos inseguros usando PHP y aplicando estos conceptos: **htmlspecialchars, CSRF idea, validacion**.
...
```bash
docker compose run --rm php php avanzado/ejercicio-028-seguridad-web-basica-battle-royale/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-028-seguridad-web-basica-battle-royale/resoluciones/tu-nombre/ejercicio.php
```
