# 04. APIs JSON - peliculas de miedo
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con peliculas de miedo. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 4 se enfoca en apis json.
...
```bash
docker compose run --rm php php avanzado/ejercicio-004-apis-json-peliculas-de-miedo/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-004-apis-json-peliculas-de-miedo/resoluciones/tu-nombre/ejercicio.php
```
