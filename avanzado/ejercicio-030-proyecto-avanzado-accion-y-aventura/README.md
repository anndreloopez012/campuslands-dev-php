# 30. Proyecto avanzado - accion y aventura
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con accion y aventura. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 30 se enfoca en proyecto avanzado.
...
Practicar construir mini sistema mantenible usando PHP y aplicando estos conceptos: **CRUD, API, seguridad, estructura**.
...
```bash
docker compose run --rm php php avanzado/ejercicio-030-proyecto-avanzado-accion-y-aventura/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-030-proyecto-avanzado-accion-y-aventura/resoluciones/tu-nombre/ejercicio.php
```
