...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con deportes. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 36 se enfoca en manejo de errores.
...
```bash
docker compose run --rm php php avanzado/ejercicio-036-manejo-de-errores-deportes/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-036-manejo-de-errores-deportes/resoluciones/tu-nombre/ejercicio.php
```
