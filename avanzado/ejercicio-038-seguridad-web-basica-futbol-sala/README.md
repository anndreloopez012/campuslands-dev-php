# 38. Seguridad web basica - futbol sala
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con futbol sala. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 38 se enfoca en seguridad web basica.
...
```bash
docker compose run --rm php php avanzado/ejercicio-038-seguridad-web-basica-futbol-sala/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-038-seguridad-web-basica-futbol-sala/resoluciones/tu-nombre/ejercicio.php
```
