# 07. Pruebas manuales y automatizables - comida
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con comida. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 7 se enfoca en pruebas manuales y automatizables.
...
```bash
docker compose run --rm php php avanzado/ejercicio-007-pruebas-manuales-y-automatizables-comida/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-007-pruebas-manuales-y-automatizables-comida/resoluciones/tu-nombre/ejercicio.php
```
