# 33. Controladores basicos - autos
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con autos. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 33 se enfoca en controladores basicos.
...
```bash
docker compose run --rm php php avanzado/ejercicio-033-controladores-basicos-autos/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-033-controladores-basicos-autos/resoluciones/tu-nombre/ejercicio.php
```
