# 03. Controladores basicos - peliculas
...
Trabajas en un modulo PHP mantenible para una plataforma relacionada con peliculas. La prioridad es estructura, seguridad, persistencia y respuestas predecibles. El caso numero 3 se enfoca en controladores basicos.
...
```bash
docker compose run --rm php php avanzado/ejercicio-003-controladores-basicos-peliculas/resoluciones/tu-nombre/ejercicio.php
```

Ejemplo con PHP instalado localmente:

```bash
php avanzado/ejercicio-003-controladores-basicos-peliculas/resoluciones/tu-nombre/ejercicio.php
```
